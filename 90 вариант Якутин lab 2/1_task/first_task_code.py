...
matrix = np.load("./1_task/first_task.npy")
size = matrix.size
matrix_props = {
    "sum": 0,
    "avr": 0,
...
with open('./1_task/first_task_result.json', 'w', encoding='utf-8') as f:
    json.dump(matrix_props, f)

norm_matrix = matrix / matrix_props['sum']
np.save("./1_task/first_task_norm_result.npy", norm_matrix)