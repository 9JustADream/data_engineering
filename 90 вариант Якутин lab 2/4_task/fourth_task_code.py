...
with open('./4_task/fourth_task_products.json', 'rb') as f:
    products = pickle.load(f)

with open('./4_task/fourth_task_updates.json', 'r', encoding = 'utf-8') as f:
    updates = json.load(f)
...
with open('./4_task/fourth_task_result.pkl', 'wb') as f:
